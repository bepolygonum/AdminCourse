    ...
    <script>
        function myReset(account) {
            if (confirm('您确定要重置该账号的密码吗？'))
                window.location.href="/reset-student?admin_account=${admin.getAccount()}&account="+account;
        }
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-title" >${item.getAccount()}</td>
                                        <td class="table-author am-hide-sm-only"><a href="#">${item.getStudentName()}</a></td>
                                        <td class="table-date am-hide-sm-only">${item.getEmail()!}</td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
